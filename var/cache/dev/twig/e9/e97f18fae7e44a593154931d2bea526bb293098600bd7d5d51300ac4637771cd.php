...
class __TwigTemplate_7572a59a581e837ff13190ca923dc5c5a5df26dcadf7a9f7ea9d87974c66b6be extends Template
{
    private $source;
    private $macros = [];
    ...
    <table class=\"table\">
        ...
        echo "</td>
            ...
            <tr>
                ...
                <td>";
        // line 28
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["calendar"]) || array_key_exists("calendar", $context) ? $context["calendar"] : (function () { throw new RuntimeError('Variable "calendar" does not exist.', 28, $this->source); })()), "descrition", [], "any", false, false, false, 28), "html", null, true);
        echo "</td>
            </tr>
            <tr>
                <th>All_day</th>
...
{% endblock %}
", "calendar/show.html.twig", "C:\\laragon\\www\\symfony\\studioAF\\templates\\calendar\\show.html.twig");
    }
}
